...
import third.task.android.items.ItemAdapter;
import third.task.android.items.ItemModel;
import third.task.android.utils.FragmentDialogAddEdit;
import third.task.android.utils.PreferencesManager;
...
public class ThirdTaskAndroid extends FragmentActivity implements FragmentDialogAddEdit.NoticeDialogListener {
	...
	@Override protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_third_task_android);
	...
	@Override public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.activity_third_task_android, menu);
